...
simple_constant
	: CONSTANT																					{
																									std::string tmp;
																									tmp = std::to_string($1);
																									$$ = new SBaseASTNode(EN_Symbol, tmp, "");
																									g_context.PushNode($$);
																								}
	;
...
postfix_expression
	...
	| postfix_expression '[' expression ']'														{
																									...
																									$$ = new SBaseASTNode(EN_PostfixArray, "{[]}", "ADD Ra, ["+offsetnode->m_Value+"]");
...
multiplicative_expression
	...
	| multiplicative_expression '*' unary_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "MUL Ra, Rb");
																									SBaseASTNode *n0=g_context.PopNode();
	...
	| multiplicative_expression '/' unary_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "DIV Ra, Rb");
																									SBaseASTNode *n0=g_context.PopNode();
																									SBaseASTNode *n1=g_context.PopNode();
																									$$->PushSubNode(n0);
																									$$->PushSubNode(n1);
	...
	| multiplicative_expression '%' unary_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "MOD Ra, Rb");
																									SBaseASTNode *n0=g_context.PopNode();
																									SBaseASTNode *n1=g_context.PopNode();
																									$$->PushSubNode(n0);
																									$$->PushSubNode(n1);
...
additive_expression
	...
	| additive_expression '+' multiplicative_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "ADD Ra, Rb");
	...
	| additive_expression '-' multiplicative_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "SUB Ra, Rb");
																									SBaseASTNode *rightnode=g_context.PopNode();
																									SBaseASTNode *leftnode=g_context.PopNode();
																									$$->PushSubNode(leftnode);
																									$$->PushSubNode(rightnode);
...
relational_expression
	...
	| relational_expression LESS_OP additive_expression											{
																									$$ = new SBaseASTNode(EN_Expression, "", "CMP.L Ra, Rb");
																									SBaseASTNode *rightnode=g_context.PopNode();
																									SBaseASTNode *leftnode=g_context.PopNode();
																									$$->PushSubNode(leftnode);
																									$$->PushSubNode(rightnode);
	...
	| relational_expression GREATER_OP additive_expression										{
																									$$ = new SBaseASTNode(EN_Expression, "", "CMP.G Ra, Rb");
																									SBaseASTNode *rightnode=g_context.PopNode();
																									SBaseASTNode *leftnode=g_context.PopNode();
																									$$->PushSubNode(leftnode);
																									$$->PushSubNode(rightnode);
	...
	| relational_expression LESSEQUAL_OP additive_expression									{
																									$$ = new SBaseASTNode(EN_Expression, "", "CMP.LE Ra, Rb");
																									SBaseASTNode *rightnode=g_context.PopNode();
																									SBaseASTNode *leftnode=g_context.PopNode();
																									$$->PushSubNode(leftnode);
																									$$->PushSubNode(rightnode);
	...
	| relational_expression GREATEREQUAL_OP additive_expression									{
																									$$ = new SBaseASTNode(EN_Expression, "", "CMP.GE Ra, Rb");
																									SBaseASTNode *rightnode=g_context.PopNode();
																									SBaseASTNode *leftnode=g_context.PopNode();
																									$$->PushSubNode(leftnode);
																									$$->PushSubNode(rightnode);
...
function_def
	: FUNCTION simple_identifier parameter_list code_block_start code_block_body code_block_end	{
																									$$ = new SBaseASTNode(EN_Decl, "", "// function definition");
