...
ld.w r0, [DrawRect:spanX]
ld.w r1, 0x140
ld.w r2, [DrawRect:spanY]
imul r1, r2
iadd r0, r1
lea r1, DrawRect:addresslow
st.w r1, r0
ld.w r0, 0x10
...
@DW 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 
@DW 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 0xFFFF 
@DW 0xFFFF 0xFFFF 0x0000 0x0000 0x0000 0x0000 0x0000 0xFF00 
@DW 0xFFFF 0x00FF 0x9AF6 0x9A9A 0x9A9A 0x9A9A 0x9A9A 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x0051 
@DW 0xFFFF 0x00FF 0x099A 0x0909 0x0909 0x0909 0x0909 0x5151 
