...
ld.w r4, 0x0100
imul r3, r4               # sprite offset at 256 byte increments
ld.w r2, 0x0400          # [r3:r2] sprite in ROM at this address (0000:0400 + spriteindex*256)
iadd r2, r3
ld.w r3, 0x0000
...
# Restore all other destroyed registers
pop r7
pop r6
pop r5
pop r4
